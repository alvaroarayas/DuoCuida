package com.duocuida.auth.exception;
...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<Map<String, Object>> manejarUsuarioNoEncontrado(WebClientResponseException.NotFound ex)
    {
        Map<String, Object> respuesta = new HashMap<>();
        respuesta.put("fecha", LocalDateTime.now());
        respuesta.put("estado", HttpStatus.BAD_REQUEST.value());
        respuesta.put("error", "Usuario no encontrado");
        respuesta.put("mensaje", "No existe un usuario asociado en el microservicio usuarios");
